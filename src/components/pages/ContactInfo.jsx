...
//         <ContactItem icon={<FaLinkedin className="text-blue-600 w-4 h-4" />} text="LinkedIn" link="https://www.linkedin.com/in/pritam-pramanik-video-editor/" />
// <ContactItem icon={<img src="https://www.gstatic.com/images/branding/product/2x/gmail_2020q4_32dp.png" alt="Gmail Logo" className="w-4 h-4" />



// } text="Gmail" link="pritampramanik2004@gmail.com" />
...
function ContactInfo({ scrollToContact, scrollToProjects }) {
  const handleContactClick = () => {
    if (scrollToContact?.current) {
      scrollToContact.current.scrollIntoView({ behavior: "smooth" });
    }
  ...
  const handleProjectsClick = () => {
    if (scrollToProjects?.current) {
      scrollToProjects.current.scrollIntoView({ behavior: "smooth", block: "start" });
    }
  };
  ...
  return (
    <div className="p-2.5 mt-2.5 bg-white rounded-lg shadow-sm">
      <div className="flex flex-col gap-3">
        <ContactItem
          icon={<FaLinkedin className="text-blue-600 w-4 h-4" />}
          text="LinkedIn"
          link="https://www.linkedin.com/in/pritam-pramanik-video-editor/"
        />
        <ContactItem
          icon={<img src="https://www.gstatic.com/images/branding/product/2x/gmail_2020q4_32dp.png" alt="Gmail Logo" className="w-4 h-4" />}
          text="Gmail"
          link="mailto:pritampramanik2004@gmail.com"
        />
      </div>
      ...
      <div className="flex flex-col gap-2.5 mt-5">
        ...
        <button
          className="py-3 w-full text-xs font-medium rounded-lg border-2 border-black border-opacity-10 text-black text-opacity-80 transition"
          onClick={handleProjectsClick}  // Scrolls to Projects section
        >
          My Projects
        </button>

        <button
          className="py-3 w-full text-xs font-medium text-white rounded-lg bg-black bg-opacity-80 hover:bg-opacity-90 transition"
